...
class SUSHIController extends Controller
{
    ...
    public function platformReport1Action(Request $request): Response
    {
        ...
        if ($customerid && $period) {
            $platformReport1Data = $this->get('subugoe_counter.report_service')->getPlatformReport1Data($customerid, $period);
        }
    ...
    public function databaseReport1Action(Request $request): Response
    {
        ...
        if ($customerid && $period) {
            $databaseReport1Data = $this->get('subugoe_counter.report_service')->getDatabaseReport1Data($customerid, $period);
        }
